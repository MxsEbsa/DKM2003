...
var CONFIG = [
	{
		...
		infoOed: {
			...
			instrucoes: 'Decifre as mensagens e clique no local onde é possível encontrar os itens que precisa comprar.',
		...
		infoCreditos: [
			...
			"<strong>Narração</strong><br />Flávio Kranic e Mariana Zink",

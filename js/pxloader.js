...
$(window).load(function(e){
	...
	var loadimagens = new Array (
		...
		/*OED*/
		"conteudo/img/akpalo_textura_matematica.png",
		"conteudo/img/background-ciencias.gif",
		"conteudo/img/background-ciencias.gif.png",
		"conteudo/img/background-geografia.gif",
		"conteudo/img/background-geografia.gif.png",
		"conteudo/img/background-historia.gif",
		"conteudo/img/background-historia.gif.png",
		"conteudo/img/background-historia.gif.png",
		"conteudo/img/background-historia.gif.png",
		"conteudo/img/background-portugues.gif",
		"conteudo/img/background-portugues.gif.png",
		"conteudo/img/bgCreditosText.png",
		"conteudo/img/bgGame1.png",
		"conteudo/img/btnAviso.png",
		"conteudo/img/btnHome.png",
		"conteudo/img/btnInstrucoes.png",
		"conteudo/img/btnMenu.png",
		"conteudo/img/btnOptionsCiencias.png",
		"conteudo/img/btnOptionsGeografia.png",
		"conteudo/img/btnOptionsHistoria.png",
		"conteudo/img/btnOptionsMatematica.png",
		"conteudo/img/btnOptionsPortugues.png",
		"conteudo/img/btnSom.png",
		"conteudo/img/btnSomOff.png",
		"conteudo/img/capa.png",
		"conteudo/img/capa-header.png",
		"conteudo/img/changeGame.png",
		"conteudo/img/close.png",
		"conteudo/img/gameMenina.png",
		"conteudo/img/gameMenino.png",
		"conteudo/img/icones.png",
		"conteudo/img/imagem1.png",
		"conteudo/img/imagem2.png",
		"conteudo/img/imagem3.png",
		"conteudo/img/imagem4.png",
		"conteudo/img/imagem5.png",
		"conteudo/img/imagem6.png",
		"conteudo/img/imagem7.png",
		"conteudo/img/imagem8.png",
		"conteudo/img/imgPopup.png",
		"conteudo/img/kbcaMenina.png",
		"conteudo/img/kbcaMenino.png",
		"conteudo/img/loader.gif",
		"conteudo/img/logo.png",
		"conteudo/img/meninaPopup.png",
		"conteudo/img/meninoPopup.png",
		"conteudo/img/pl-casaDosAvos.png",
		"conteudo/img/pl-casaDosAvos-hover.png",
		"conteudo/img/pl-lojaDeAnimais.png",
		"conteudo/img/pl-lojaDeAnimais-hover.png",
		"conteudo/img/pl-lojaDeMalas.png",
		"conteudo/img/pl-lojaDeMalas-hover.png",
		"conteudo/img/pl-oficinaMecanica.png",
		"conteudo/img/pl-oficinaMecanica-hover.png",
		"conteudo/img/pl-padaria.png",
		"conteudo/img/pl-padaria-hover.png",
		"conteudo/img/pl-postoDeGasolina.png",
		"conteudo/img/pl-postoDeGasolina-hover.png",
		"conteudo/img/pl-suaCasa.png",
		"conteudo/img/pl-suaCasa-hover.png",
		"conteudo/img/pl-supermercado.png",
		"conteudo/img/pl-supermercado-hover.png",
		"conteudo/img/setaPopup.png"
